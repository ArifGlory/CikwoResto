 ...
 */
public class RecycleAdapterPesananBelumVerifikasi extends RecyclerView.Adapter<RecycleViewHolderListPesanan> {
    ...
    public RecycleAdapterPesananBelumVerifikasi(final Context context) {
    ...
    public void onBindViewHolder(RecycleViewHolderListPesanan holder, final int position) {
        ...
        holder.txtStatus.setText(statusPesanan);
